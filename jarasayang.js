...
function renderAlbum(n) {
    ...
    // Tentukan foto berdasarkan tombol yang diklik
    if(n === 1) {
        img.src = "LUCU1.jpg"; // GANTI dengan nama file foto lucumu
    }
    if(n === 2) {
        img.src = "CANTIK.jpg"; // GANTI dengan nama file foto cantikmu
    }
    if(n === 3) {
        img.src = "RANDOM.jpg"; // GANTI dengan nama file foto randommu
    }

    // Atur ukuran agar satu foto terlihat pas (opsional)
    img.style.gridColumn = "span 2"; 
    img.style.height = "auto";
    img.style.width = "100%";

    // Masukkan gambar ke dalam album-display
    d.appendChild(img);
}
